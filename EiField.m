function [resR,resTh,resPhi] = EiField(r,th,phi,sphr,epiNL,n,l,m,EiR,EiTh,EiPhi,E0r,E0th,E0phi,coeff1,coeff2)
    [Mr,Mth,Mphi] = MOField(r,th,phi,sphr,epiNL,n,l,m);
    [Nr,Nth,Nphi] = NEField(r,th,phi,sphr,epiNL,n,l,m);
